...
thos(BuildContext context) {
  final snackBar = SnackBar(
    ...
    content: AwesomeSnackbarContent(
      title: 'Alamat Anda Berhasil Di Ubah',
...
gagal(BuildContext context) {
  final snackBar = SnackBar(
    ...
    backgroundColor: Colors.transparent,
    content: AwesomeSnackbarContent(
      title: 'Alamat Anda Tidak Berhasil Di Ubah',
      message: 'Pastikan Anda Menuliskan Kata Sandi yang Benar :)',
  ...
  Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => EditAlamat()),
  );
}
                ...
                children: [
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  hintText: "${snapshot.data?.pasien_alamat}",
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        print("alamat adalah ${alamat.text} ");
                        print("password == ${password.text}");
                        Update.ubahalamat(
                          idUser: '4',
                          alamatBaru: alamat.text,
